...
//  override def newDB(): Map[Int, Int] =
...
//      val db = newDB()
//
//      db.put(1, 0).unsafeGet
//
//      val functionID = db.registerFunction(1, value => Apply.Update(value + 1))
//
//      (1 to 1000).par foreach {
//        _ =>
//          db.applyFunction(1, functionID).unsafeGet
//      }
//
//      db.unsafeGet(1).unsafeGet should contain(1000)
//
...
//          (1 to 1000).par foreach {
//            i =>
//              db.applyFunction(i, functionID).unsafeGet
//          }
//      }
//
//      (1 to 1000).par foreach {
//        i =>
//          db.unsafeGet(i).unsafeGet should contain(100)
//      }
//
//      db.closeDatabase().unsafeGet
//    }
...
//      (1 to 1000).par foreach {
//        i =>
//          db.unsafeGet(i).unsafeGet should contain(0)
//      }
//
//      db.closeDatabase().unsafeGet
//    }
