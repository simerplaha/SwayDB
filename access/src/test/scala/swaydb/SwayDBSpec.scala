...
//      db.unsafeGet(1).assertGet shouldBe "updated"
...
//          (1 to 2000000) foreach {
//            i =>
//              db.unsafeGet(i).assertGet shouldBe i.toString
//              if (i % 100000 == 0)
//                println(s"Read $i")
//          }
//        }
