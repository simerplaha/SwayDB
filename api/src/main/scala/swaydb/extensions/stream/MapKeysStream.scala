...
//                      isReverse: Boolean,
//                      mapsOnly: Boolean,
//                      thisMapKeyBytes: Slice[Byte])(implicit keySerializer: Serializer[K]): IO[Core.Error.Private, Option[Key[K]]] =
...
//
//  private def headOptionInner: IO[Core.Error.Private, Option[Key[K]]] = {
...
//  }
//
//  override def headOption: IO[Core.Error.Private, Option[K]] =
...
//        })
//
//      override private[swaydb] def next(previous: K): IO[Core.Error.Private, Option[K]] =
//        MapKeysStream.step(
...
//    */
//  override def lastOption: IO[Core.Error.Private, Option[K]] =
//    reverse.headOption
//
