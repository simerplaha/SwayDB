...
sealed trait FromSpec extends TestBaseEmbedded {
  ...
  "From" should {
    ...
    "Sibling maps" in {
      ...
      subMap1.from(3).materialize.get shouldBe empty
      subMap1.after(2).materialize.get shouldBe empty
      subMap1.from(1).materialize.get should contain inOrderOnly((1, "one"), (2, "two"))
      subMap1.fromOrBefore(2).materialize.get should contain only ((2, "two"))
      subMap1.fromOrBefore(1).materialize.get should contain inOrderOnly((1, "one"), (2, "two"))
      subMap1.after(0).materialize.get should contain inOrderOnly((1, "one"), (2, "two"))
      subMap1.fromOrAfter(0).materialize.get should contain inOrderOnly((1, "one"), (2, "two"))
      ...
      subMap2.from(5).materialize.get shouldBe empty
      subMap2.after(4).materialize.get shouldBe empty
      subMap2.from(3).materialize.get should contain inOrderOnly((3, "three"), (4, "four"))
      subMap2.fromOrBefore(5).materialize.get should contain only ((4, "four"))
      subMap2.fromOrBefore(3).materialize.get should contain inOrderOnly((3, "three"), (4, "four"))
      subMap2.after(0).materialize.get should contain inOrderOnly((3, "three"), (4, "four"))
      subMap2.fromOrAfter(1).materialize.get should contain inOrderOnly((3, "three"), (4, "four"))
    ...
    "nested maps" in {
      ...
      subMap1.from(4).materialize.get shouldBe empty
      subMap1.after(3).materialize.get shouldBe empty
      subMap1.from(1).materialize.get should contain inOrderOnly((1, "one"), (2, "two"))
      subMap1.maps.from(1).materialize.get shouldBe empty
      subMap1.maps.after(1).materialize.get should contain only ((3, "sub map 2"))
      subMap1.fromOrBefore(2).materialize.get should contain only ((2, "two"))
      subMap1.maps.fromOrBefore(2).materialize.get should contain only ((3, "sub map 2"))

      subMap1.fromOrBefore(1).materialize.get should contain inOrderOnly((1, "one"), (2, "two"))
      subMap1.maps.fromOrBefore(1).materialize.get should contain only ((3, "sub map 2"))
      subMap1.after(0).materialize.get should contain inOrderOnly((1, "one"), (2, "two"))
      subMap1.maps.after(0).materialize.get should contain only ((3, "sub map 2"))
      subMap1.fromOrAfter(0).materialize.get should contain inOrderOnly((1, "one"), (2, "two"))
      subMap1.maps.fromOrAfter(0).materialize.get should contain only ((3, "sub map 2"))
      subMap1.size.assertGet shouldBe 2
