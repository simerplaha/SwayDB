...
sealed trait MapIterationSpec extends TestBaseEmbedded {
  ...
  "Iteration" should {
    "exclude & include subMap by default" in {
      ...
      firstMap.maps.materialize.get should contain only ((2, "first map"))

      secondMap.materialize.get shouldBe empty
      secondMap.maps.materialize.get should contain only((3, "sub map 1"), (4, "sub map 2"))

      subMap1.materialize.get shouldBe empty
      subMap2.materialize.get shouldBe empty
  ...
  "Iteration" when {
    ...
    "Sibling maps" in {
      ...
      rootMap.maps.materialize.get should contain only((2, "sub map 1"), (3, "sub map 2"))
    ...
    "nested maps" in {
      ...
      rootMap.materialize.get shouldBe empty
      rootMap.maps.materialize.get should contain only ((2, "sub map 1"))
