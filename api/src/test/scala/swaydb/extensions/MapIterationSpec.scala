...
sealed trait MapIterationSpec extends TestBase with TestBaseEmbedded {
  ...
  "Iteration" should {
    "exclude & include subMap by default" in {
      ...
      firstMap.toSeq.get shouldBe empty
      firstMap.maps.toSeq.get should contain only ((2, "first map"))

      secondMap.toSeq.get shouldBe empty
      secondMap.maps.toSeq.get should contain only((3, "sub map 1"), (4, "sub map 2"))

      subMap1.toSeq.get shouldBe empty
      subMap2.toSeq.get shouldBe empty
  ...
  "Iteration" when {
    "the map contains 1 element" in {
      ...
      secondMap.map(keyValue => (keyValue._1 + 1, keyValue._2)).get.toSeq.get should contain only ((2, "one"))
      ...
      secondMap.reverse.map(keyValue => (keyValue._1 + 1, keyValue._2)).get.toSeq.get should contain only ((2, "one"))
    ...
    "the map contains 2 elements" in {
      ...
      firstMap.map(keyValue => (keyValue._1 + 1, keyValue._2)).get.toSeq.get shouldBe List((2, "one"), (3, "two"))
      ...
      firstMap.reverse.map(keyValue => keyValue).get.toSeq.get shouldBe List((2, "two"), (1, "one"))
    ...
    "Sibling maps" in {
      ...
      rootMap.maps.toSeq.get should contain only((2, "sub map 1"), (3, "sub map 2"))
      ...
      subMap1.map(keyValue => (keyValue._1 + 1, keyValue._2)).get.toSeq.get shouldBe List((2, "one"), (3, "two"))
      ...
      subMap1.reverse.map(keyValue => keyValue).get.toSeq.get shouldBe List((2, "two"), (1, "one"))
      ...
      subMap2.map(keyValue => (keyValue._1, keyValue._2)).get.toSeq.get shouldBe List((3, "three"), (4, "four"))
      ...
      subMap2.reverse.map(keyValue => keyValue).get.toSeq.get shouldBe List((4, "four"), (3, "three"))
    ...
    "nested maps" in {
      ...
      rootMap.toSeq.get shouldBe empty
      rootMap.maps.toSeq.get should contain only ((2, "sub map 1"))
      ...
      subMap1.map(keyValue => (keyValue._1, keyValue._2)).get.toSeq.get shouldBe List((1, "one"), (2, "two"))
      subMap1.maps.map(keyValue => (keyValue._1, keyValue._2)).get.toSeq.get shouldBe List((3, "sub map 2"))
      subMap1.maps.map(keyValue => (keyValue._1, keyValue._2)).get.toSeq.get shouldBe List((3, "sub map 2"))
      subMap1.foldLeft(List.empty[(Int, String)]) { case (previous, keyValue) => previous :+ keyValue }.get shouldBe List((1, "one"), (2, "two"))
      ...
      subMap1.reverse.map(keyValue => keyValue).get.toSeq.get shouldBe List((2, "two"), (1, "one"))
      subMap1.maps.reverse.map(keyValue => keyValue).get.toSeq.get shouldBe List((3, "sub map 2"))
      subMap1.maps.reverse.map(keyValue => keyValue).get.toSeq.get shouldBe List((3, "sub map 2"))
      subMap1.reverse.take(100).toSeq.get shouldBe List((2, "two"), (1, "one"))
