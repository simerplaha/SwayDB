...
sealed trait MapSpec extends TestBaseEmbedded {
  ...
  "Extend" should {
    ...
    "getMap, containsMap, exists & getMapValue" in {
      ...
      subMapGet.materialize.get shouldBe ListBuffer((1, "one"), (2, "two"))
    ...
    "batch expire" in {
      ...
      eventual {
        rootMap.materialize.get shouldBe empty
        subMap.materialize.get shouldBe empty
      }
    ...
    "batchPut" in {
      ...
      rootMap.materialize.get shouldBe ListBuffer((1, "one"), (2, "two"))
      subMap.materialize.get shouldBe ListBuffer((1, "one one"), (2, "two two"))
    ...
    "batchUpdate" in {
      ...
      rootMap.materialize.get shouldBe ListBuffer((1, "one updated"), (2, "two updated"))
      subMap.materialize.get shouldBe ListBuffer((1, "one one updated"), (2, "two two updated"))
    ...
    "batchExpire" in {
      ...
      eventual {
        rootMap.materialize.get should contain only ((2, "two"))
        subMap.materialize.get shouldBe empty
      }
  ...
  "SubMap" when {
    ...
    "maps.put on a existing map" should {
      ...
      "replace existing map and all it's entries" in {
        ...
        second.materialize.get shouldBe List((1, "one"), (2, "two"), (3, "three"))
        ...
        second.materialize.get shouldBe empty
      ...
      "replace existing map and all it's entries and also all existing maps subMap and all their entries" in {
        ...
        /**
          ...
          */
        second.materialize.get shouldBe List((1, "second one"), (2, "second two"), (3, "second three"))
        third.materialize.get shouldBe List((1, "third one"), (2, "third two"), (3, "third three"))
        fourth.materialize.get shouldBe List((1, "fourth one"), (2, "fourth two"), (3, "fourth three"))

        second.materialize.get shouldBe List((1, "second one"), (2, "second two"), (3, "second three"))
        third.materialize.get shouldBe List((1, "third one"), (2, "third two"), (3, "third three"))
        fourth.materialize.get shouldBe List((1, "fourth one"), (2, "fourth two"), (3, "fourth three"))

        second.maps.materialize.get shouldBe List((3, "third"))
        third.maps.materialize.get shouldBe List((4, "fourth"))
        fourth.maps.materialize.get shouldBe empty
        ...
        //all the old entries are removed
        second.materialize.get shouldBe empty
        third.materialize.get shouldBe empty
        fourth.materialize.get shouldBe empty
    ...
    "clear" should {
      "remove all key-values from a map" in {
        ...
        second.materialize.get should have size 3
        second.clear().assertGet
        second.materialize.get shouldBe empty

        third.materialize.get should have size 3
