...
//  override val db = memory.Map[Slice[Byte], Option[Slice[Byte]]]().unsafeGet
//}
//
...
//  override val db =
//    if (mmap)
//      persistent.Map[Slice[Byte], Option[Slice[Byte]]](dir = dir).unsafeGet
//    else
//      persistent.Map[Slice[Byte], Option[Slice[Byte]]](dir = dir, mmapMaps = false, mmapAppendix = false, mmapSegments = MMAP.Disabled).unsafeGet
//}