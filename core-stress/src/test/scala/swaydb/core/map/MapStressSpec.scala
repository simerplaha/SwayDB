...
//
//      def test(map: Map[SliceOptional[Byte], MemoryOptional, Slice[Byte], Memory]) = {
//        keyValues foreach {
//          keyValue =>
...
//      }
//
//      def testRead(map: Map[SliceOptional[Byte], MemoryOptional, Slice[Byte], Memory]) =
//        keyValues foreach {
//          keyValue =>
...
//
//      test(Map.persistent[SliceOptional[Byte], MemoryOptional, Slice[Byte], Memory](dir1, mmap = true, flushOnOverflow = true, 1.kb, dropCorruptedTailEntries = false).runRandomIO.right.value.item)
//      test(Map.persistent[SliceOptional[Byte], MemoryOptional, Slice[Byte], Memory](dir2, mmap = false, flushOnOverflow = true, 1.kb, dropCorruptedTailEntries = false).runRandomIO.right.value.item)
...
//      testRead(Map.persistent[SliceOptional[Byte], MemoryOptional, Slice[Byte], Memory](dir1, mmap = false, flushOnOverflow = true, 1.kb, dropCorruptedTailEntries = false).runRandomIO.right.value.item)
//      testRead(Map.persistent[SliceOptional[Byte], MemoryOptional, Slice[Byte], Memory](dir2, mmap = true, flushOnOverflow = true, 1.kb, dropCorruptedTailEntries = false).runRandomIO.right.value.item)
//
