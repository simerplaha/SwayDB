...
private[compression] case class ValueCompressionResult(compressedValues: Slice[Byte],
                                                       valuesCompression: CompressionInternal)

private[compression] case class CompressionResult(compressedIndex: Slice[Byte],
