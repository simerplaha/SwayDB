...
//  */
//
//private[core] class BlockDataReader[+PB: Block, +CB: Block](_parentBlockReader: BlockReader[PB],
//                                                            override val block: CB) extends BlockReader(_parentBlockReader, block) with LazyLogging {
//  def parentBlockReader: BlockReader[PB] =
//    _parentBlockReader
//}
