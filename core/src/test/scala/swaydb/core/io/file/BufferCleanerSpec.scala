...
//    val file: DBFile = DBFile.mmapWriteAndRead(randomDir, randomIOStrategy(), autoClose = true, Slice(randomBytesSlice())).get
//
//    eventual(10.seconds) {
//      file.file match {
...
//        (1 to 20) map {
//          _ =>
//            val file = DBFile.mmapWriteAndRead(randomDir, randomIOStrategy(), autoClose = true, Slice(randomBytesSlice())).get
//            file.delete().get
//            file
//        }
//
