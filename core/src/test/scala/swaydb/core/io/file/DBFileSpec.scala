...
//
//      DBFile.write(testFile, bytes).runRandomIO.value
//      IO(DBFile.write(testFile, bytes)).left.runRandomIO.value shouldBe a[FileAlreadyExistsException] //creating the same file again should fail
...
//
//      IO(file.readAll).left.runRandomIO.value.exception shouldBe a[NonReadableChannelException]
//      file.read(0, 1).left.runRandomIO.value.exception shouldBe a[NonReadableChannelException]
//      file.get(0).left.runRandomIO.value.exception shouldBe a[NonReadableChannelException]
//
...
//      file.append(bytes).left.runRandomIO.value.exception shouldBe a[NonWritableChannelException]
//
//      file.close.runRandomIO.value
//
//      DBFile.channelRead(
...
//      Effect.readAll(testFile).value shouldBe bytes
...
//        blockCacheFileId = idGenerator.nextID,
//        autoClose = true
//      ).left.runRandomIO.value.exception.toString shouldBe new FileAlreadyExistsException(testFile.toString).toString
//
//      //file remains unchanged
//      DBFile.channelRead(
//        path = testFile,
...
//      //      } repeat 3.times
//
//      Effect.write(testFile, bytes).runRandomIO.value
//
...
//      readFile.append(bytes).left.runRandomIO.value.exception shouldBe a[NonWritableChannelException]
...
//        autoClose = true,
//        blockCacheFileId = idGenerator.nextID
//      ).left.runRandomIO.value.exception shouldBe a[NoSuchFileException]
//    }
//  }
//
...
//      file.append(bytes).left.runRandomIO.value.exception shouldBe a[ReadOnlyBufferException]
//      file.close.runRandomIO.value
//
...
//        blockCacheFileId = idGenerator.nextID,
//        bytes = bytes
//      ).left.runRandomIO.value.exception shouldBe swaydb.Exception.FailedToWriteAllBytes(0, 2, bytes.size)
//    }
//
//    "fail to write if the file already exists" in {
//      val testFile = randomFilePath
...
//        blockCacheFileId = idGenerator.nextID,
//        bytes = bytes
//      ).left.runRandomIO.value.exception shouldBe a[FileAlreadyExistsException] //creating the same file again should fail
//
//      //file remains unchanged
//      DBFile.mmapRead(
//        path = testFile,
...
//      doRead
//
//      DBFile.write(testFile, bytes).left.runRandomIO.value.exception shouldBe a[FileAlreadyExistsException] //creating the same file again should fail
//
//      readFile.close.runRandomIO.value
//    }
//
...
//      file.read(0, 1).isLeft shouldBe true //not open for read
//
//      file.close.runRandomIO.value
//
