...
//        inSequence {
//          //@formatter:off
//          current.higher        _ expects (0: Slice[Byte])  returning IO(LevelSeek.Some(0, randomRemoveOrUpdateOrFunctionRemove(1)))
//          next.stateID          _ expects ()                returning 1
//          next.higher           _ expects (0: Slice[Byte])  returning IO.Defer.none
...
//          current.higher        _ expects (0: Slice[Byte])  returning IO(LevelSeek.Some(0, randomRemoveOrUpdateOrFunctionRemove(1)))
//          next.stateID          _ expects ()                returning 1
//          next.higher           _ expects (0: Slice[Byte])  returning IO(Some(randomPutKeyValue(1))).toDeferred
//          next.hasStateChanged  _ expects 1                 returning false
//          current.higher        _ expects (1: Slice[Byte])  returning LevelSeek.none
...
//          current.higher        _ expects (0: Slice[Byte])  returning IO(LevelSeek.Some(0, randomRemoveOrUpdateOrFunctionRemove(1)))
//          next.stateID          _ expects ()                returning 1
//          next.higher           _ expects (0: Slice[Byte])  returning IO(Some(randomPutKeyValue(2))).toDeferred
//          next.hasStateChanged  _ expects 1                 returning false repeat 2.times
//          current.higher        _ expects (1: Slice[Byte])  returning IO(LevelSeek.Some(0, randomRemoveOrUpdateOrFunctionRemove(2)))
//          next.hasStateChanged  _ expects 1                 returning false
