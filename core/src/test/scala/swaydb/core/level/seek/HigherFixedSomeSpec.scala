...
//        inSequence {
//          //@formatter:off
//          current.higher        _ expects (0: Slice[Byte])  returning IO(LevelSeek.Some(1, put))
...
//        inSequence {
//          //@formatter:off
//          current.higher        _ expects (0: Slice[Byte])  returning IO(LevelSeek.Some(1, upperKeyValue))
