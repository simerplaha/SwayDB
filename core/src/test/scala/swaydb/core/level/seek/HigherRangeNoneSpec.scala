        ...
        runThis(100.times) {
          ...
          (0 to 9) foreach {
            key =>
              ...
              inSequence {
                //@formatter:off
                current.higher        _ expects (key: Slice[Byte])  returning IO(LevelSeek.Some(1, randomRangeKeyValue(0, 10, rangeValue = randomUpdateRangeValue())))
        ...
        runThis(100.times) {
          ...
          (0 to 9) foreach {
            key =>
              ...
              inSequence {
                //@formatter:off
                current.higher        _ expects (key: Slice[Byte])  returning IO(LevelSeek.Some(1, randomRangeKeyValue(0, 10, None, randomRemoveOrUpdateOrFunctionRemoveValue(addFunctions = false))))
                current.get           _ expects (10: Slice[Byte])   returning IO.Defer.none
                current.higher        _ expects (10: Slice[Byte])   returning LevelSeek.none
    ...
    "2" when {
      ...
      "range value is not removed or expired" in {
        runThis(100.times) {
          ...
          inSequence {
            //@formatter:off
            current.higher        _ expects (0: Slice[Byte])    returning IO(LevelSeek.Some(1, randomRangeKeyValue(1, 10, randomFromValueOption(addPut = false), randomUpdateRangeValue())))
      ...
      "range value is removed or expired" in {
        ...
        runThis(100.times) {
          ...
          inSequence {
            //@formatter:off
            current.higher        _ expects (0: Slice[Byte])    returning IO(LevelSeek.Some(1, currentHigher))
            next.higher           _ expects (0: Slice[Byte])    returning IO.Defer.none
            current.get           _ expects (10: Slice[Byte])   returning IO.Defer.none
            current.higher        _ expects (10: Slice[Byte])   returning LevelSeek.none
            //@formatter:on
