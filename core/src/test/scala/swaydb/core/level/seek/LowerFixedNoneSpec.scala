  ...
  "return None" when {
    ...
    "2" in {
      ...
      runThis(1.times) {
        ...
        inSequence {
          //@formatter:off
          current.lower         _ expects (1: Slice[Byte])  returning IO(LevelSeek.Some(1, randomRemoveOrUpdateOrFunctionRemove(0)))
    ...
    "4" in {
      ...
      runThis(100.times) {
        ...
        inSequence {
          //@formatter:off
          current.lower         _ expects (2: Slice[Byte])  returning IO(LevelSeek.Some(1, randomRemoveOrUpdateOrFunctionRemove(1)))
