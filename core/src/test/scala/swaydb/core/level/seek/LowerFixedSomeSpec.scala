...
//        inSequence {
//          //@formatter:off
//          current.lower         _ expects (1: Slice[Byte])  returning IO(LevelSeek.Some(1, put))
...
//        inSequence {
//          //@formatter:off
//          current.lower         _ expects (1: Slice[Byte])  returning IO(LevelSeek.Some(1, upperKeyValue))
...
//        inSequence {
//          //@formatter:off
//          current.lower         _ expects (2: Slice[Byte])  returning IO(LevelSeek.Some(1, upperKeyValue))
