        ...
        runThis(100.times) {
          ...
          (0 to 20).reverse foreach {
            key =>
              ...
              inSequence {
                //@formatter:off
                current.lower         _ expects (key: Slice[Byte])  returning IO(LevelSeek.Some(1, randomRangeKeyValue(0, 10, randomFromValueOption(addPut = false), rangeValue = randomUpdateRangeValue())))
        ...
        runThis(100.times) {
          ...
          (1 to 10).reverse foreach {
            key =>
              ...
              inSequence {
                //@formatter:off
                current.lower         _ expects (key: Slice[Byte])  returning IO(LevelSeek.Some(1, randomRangeKeyValue(0, 10, Some(randomRemoveOrUpdateOrFunctionRemoveValue(addFunctions = false)), randomRemoveOrUpdateOrFunctionRemoveValue(addFunctions = false))))
                next.lower            _ expects (key: Slice[Byte])  returning IO.Defer.none
                current.lower         _ expects (0: Slice[Byte])    returning LevelSeek.none
                //@formatter:on
              }
    ...
    "2" when {
        ...
        runThis(1.times) {
          ...
          (1 to 20).reverse foreach {
            key =>
              ...
              inSequence {
                //@formatter:off
                current.lower         _ expects (key: Slice[Byte])  returning IO(LevelSeek.Some(1, randomRangeKeyValue(1, 10, randomFromValueOption(addPut = false), randomUpdateRangeValue())))
                next.lower            _ expects (key: Slice[Byte])  returning IO.Defer.none
        ...
        runThis(100.times) {
          ...
          (2 to 10).reverse foreach {
            key =>
              ...
              inSequence {
                //@formatter:off
                current.lower         _ expects (key: Slice[Byte])  returning IO(LevelSeek.Some(1, randomRangeKeyValue(1, 10, Some(randomRemoveOrUpdateOrFunctionRemoveValue()), randomRemoveOrUpdateOrFunctionRemoveValue(addFunctions = false))))
                next.lower            _ expects (key: Slice[Byte])  returning IO.Defer.none
                current.lower         _ expects (1: Slice[Byte])    returning LevelSeek.none
                //@formatter:on
              }
      ...
      "range value is removed or expired and fromKey has a gap with toKey" in {
        ...
        runThis(100.times) {
          ...
          inSequence {
            //@formatter:off
            current.lower         _ expects (12: Slice[Byte])   returning IO(LevelSeek.Some(1, randomRangeKeyValue(1, 10, Some(randomRemoveOrUpdateOrFunctionRemoveValue()), randomRemoveOrUpdateOrFunctionRemoveValue(addFunctions = false))))
