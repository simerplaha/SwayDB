...
class LevelZeroSkipListMergerSpec extends WordSpec with Matchers {
  ...
  "insert" should {
    ...
    "insert overlapping ranges when insert fromKey is less than existing range's fromKey" in {
      ...
      skipList.get(1: Slice[Byte]).getS shouldBe Memory.Range(1, 10, Value.FromValue.None, Value.update(40))
      skipList.get(10: Slice[Byte]).getS shouldBe Memory.Range(10, 15, Value.FromValue.None, Value.update(40))
      skipList.get(15: Slice[Byte]).getS shouldBe Memory.Range(15, 20, Value.FromValue.None, Value.update(20))
    }
    ...
    "insert overlapping ranges when insert fromKey is greater than existing range's fromKey" in {
      ...
      skipList.get(1: Slice[Byte]).getS shouldBe Memory.Range(1, 10, Value.FromValue.None, Value.update(40))
      skipList.get(10: Slice[Byte]).getS shouldBe Memory.Range(10, 15, Value.FromValue.None, Value.update(20))
      skipList.get(15: Slice[Byte]).getS shouldBe Memory.Range(15, 20, Value.FromValue.None, Value.update(20))
    }
    ...
    "insert overlapping ranges without values set and no splits required" in {
      ...
      skipList.get(1: Slice[Byte]).getS shouldBe Memory.Range(1, 5, Value.FromValue.None, Value.update(5))
      skipList.get(5: Slice[Byte]).getS shouldBe Memory.Range(5, 10, Value.FromValue.None, Value.update(10))
      skipList.get(10: Slice[Byte]).getS shouldBe Memory.Range(10, 20, Value.FromValue.None, Value.update(100))
      skipList.get(20: Slice[Byte]).getS shouldBe Memory.Range(20, 30, Value.FromValue.None, Value.update(100))
      skipList.get(30: Slice[Byte]).getS shouldBe Memory.Range(30, 40, Value.FromValue.None, Value.update(100))
      skipList.get(40: Slice[Byte]).getS shouldBe Memory.Range(40, 50, Value.FromValue.None, Value.update(100))
      skipList.get(50: Slice[Byte]).getS shouldBe Memory.Range(50, 100, Value.FromValue.None, Value.update(100))
    }
    ...
    "insert overlapping ranges with values set and splits required" in {
      ...
      skipList.get(1: Slice[Byte]).getS shouldBe Memory.Range(1, 5, Value.put(1), Value.update(5))
      skipList.get(5: Slice[Byte]).getS shouldBe Memory.Range(5, 7, Value.FromValue.None, Value.update(10))
      skipList.get(7: Slice[Byte]).getS shouldBe Memory.Range(7, 10, Value.FromValue.None, Value.update(100))
      skipList.get(10: Slice[Byte]).getS shouldBe Memory.Range(10, 20, Value.put(100), Value.update(100))
      skipList.get(20: Slice[Byte]).getS shouldBe Memory.Range(20, 30, Value.FromValue.None, Value.update(100))
      skipList.get(30: Slice[Byte]).getS shouldBe Memory.Range(30, 35, Value.put(100), Value.update(100))
      skipList.get(35: Slice[Byte]).getS shouldBe Memory.Range(35, 40, Value.FromValue.None, Value.update(40))
      skipList.get(40: Slice[Byte]).getS shouldBe Memory.Range(40, 50, Value.FromValue.None, Value.update(50))
    }
    ...
    "remove range should remove invalid entries" in {
      ...
      skipList.get(2: Slice[Byte]).getS shouldBe Memory.Range(2, 5, Value.FromValue.None, Value.remove(None))
    ...
    "remove range when skipList is empty" in {
      ...
      skipList.get(2: Slice[Byte]).getS shouldBe Memory.Range(2, 100, Value.FromValue.None, Value.remove(None))
      skipList.get(3: Slice[Byte]).toOptionS shouldBe empty
      skipList.get(4: Slice[Byte]).toOptionS shouldBe empty
    }
    ...
    "remove range should clear removed entries when remove ranges overlaps the left edge" in {
      ...
      skipList.get(1: Slice[Byte]).getS shouldBe Memory.put(1, 1)
      skipList.get(2: Slice[Byte]).getS shouldBe Memory.Range(2, 4, Value.FromValue.None, Value.remove(None))
      skipList.get(3: Slice[Byte]).toOptionS shouldBe empty
      skipList.get(4: Slice[Byte]).getS shouldBe Memory.Range(4, 5, Value.FromValue.None, Value.remove(None))
      skipList.get(5: Slice[Byte]).getS shouldBe Memory.Range(5, 8, Value.FromValue.None, Value.remove(None))
