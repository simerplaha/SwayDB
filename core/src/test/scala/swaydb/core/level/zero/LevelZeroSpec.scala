...
//      println
//      zero.head(ReadState.random).runRandomIO.value.value.getOrFetchValue shouldBe ("two": Slice[Byte])
//
//      zero.remove(2).runRandomIO
//      zero.remove(3).runRandomIO
//      zero.remove(4).runRandomIO
//
//      zero.head(ReadState.random).runRandomIO.value.value.getOrFetchValue shouldBe ("five": Slice[Byte])
//
...
//
//      zero.last(ReadState.random).runRandomIO.runRandomIO.right.value.value.getOrFetchValue shouldBe ("five": Slice[Byte])
//
//      //remove 5
//      zero.remove(5).runRandomIO
//      zero.last(ReadState.random).runRandomIO.runRandomIO.right.value.value.getOrFetchValue shouldBe ("four": Slice[Byte])
//
//      zero.remove(2).runRandomIO
//      zero.remove(3).runRandomIO
//      zero.remove(4).runRandomIO
//
//      println
//      zero.last(ReadState.random).runRandomIO.runRandomIO.right.value.value.getOrFetchValue shouldBe ("one": Slice[Byte])
//
//      zero.remove(1).runRandomIO
//      zero.last(ReadState.random).runRandomIO.right.value shouldBe empty
//      zero.head(ReadState.random).runRandomIO.right.value shouldBe empty
