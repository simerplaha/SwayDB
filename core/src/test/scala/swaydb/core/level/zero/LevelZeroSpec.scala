...
//        zero.get(1, ThreadReadState.random).runRandomIO.right.value.value.getOrFetchValue shouldBe ("one": Slice[Byte])
//
//        zero.put("2", "two").runRandomIO
//        zero.get("2", ThreadReadState.random).runRandomIO.right.value.value.getOrFetchValue shouldBe ("two": Slice[Byte])
//      }
//
...
//
//      val gotFromLevelZero = zero.get(one, ThreadReadState.random).runRandomIO.right.value.value.getOrFetchValue.getC
...
//        val gotFromLevelOne = level.get(one, ThreadReadState.random).runRandomIO.right.value.value
...
//      zero.get(1, ThreadReadState.random).runRandomIO.right.value.value.getOrFetchValue shouldBe Slice.empty
//    }
//
...
//        zero.get(key1, ThreadReadState.random).runRandomIO.right.value.value.getOrFetchValue shouldBe value1
//        zero.get(key2, ThreadReadState.random).runRandomIO.right.value.value.getOrFetchValue shouldBe value2
//      }
//
//      val zero = TestLevelZero(Some(TestLevel(throttle = _ => Throttle(10.seconds, 0))))
//
...
//
//      zero.get("one", ThreadReadState.random).runRandomIO.right.value.value.getOrFetchValue.toOptionC shouldBe empty
//      zero.get("two", ThreadReadState.random).runRandomIO.right.value.value.getOrFetchValue.toOptionC shouldBe empty
//
...
//        zero.head(ThreadReadState.random).runRandomIO.get shouldBe defined
//
//      keyValues foreach {
//        keyValue =>
...
//      }
//
//      zero.head(ThreadReadState.random).runRandomIO.right.value shouldBe empty
//      zero.last(ThreadReadState.random).runRandomIO.right.value shouldBe empty
//    }
//
...
//
//      val head = zero.head(ThreadReadState.random).runRandomIO.value.value
...
//      println
//      zero.head(ThreadReadState.random).runRandomIO.value.value.getOrFetchValue shouldBe ("two": Slice[Byte])
//
//      zero.remove(2).runRandomIO
//      zero.remove(3).runRandomIO
//      zero.remove(4).runRandomIO
//
//      zero.head(ThreadReadState.random).runRandomIO.value.value.getOrFetchValue shouldBe ("five": Slice[Byte])
//
//      zero.remove(5).runRandomIO
//      zero.head(ThreadReadState.random).runRandomIO.value shouldBe empty
//      zero.last(ThreadReadState.random).runRandomIO.value shouldBe empty
//    }
//  }
//
...
//
//      zero.last(ThreadReadState.random).runRandomIO.runRandomIO.right.value.value.getOrFetchValue shouldBe ("five": Slice[Byte])
//
//      //remove 5
//      zero.remove(5).runRandomIO
//      zero.last(ThreadReadState.random).runRandomIO.runRandomIO.right.value.value.getOrFetchValue shouldBe ("four": Slice[Byte])
//
//      zero.remove(2).runRandomIO
//      zero.remove(3).runRandomIO
//      zero.remove(4).runRandomIO
//
//      println
//      zero.last(ThreadReadState.random).runRandomIO.runRandomIO.right.value.value.getOrFetchValue shouldBe ("one": Slice[Byte])
//
//      zero.remove(1).runRandomIO
//      zero.last(ThreadReadState.random).runRandomIO.right.value shouldBe empty
//      zero.head(ThreadReadState.random).runRandomIO.right.value shouldBe empty
