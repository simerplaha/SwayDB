...
//
//      val map = Map.memory[Slice[Byte], Memory](fileSize = 1.mb, flushOnOverflow = false, nullKey = Slice.nulled, nullValue = Memory.Null)
//
...
//
//      val map = Map.memory[Slice[Byte], Segment](fileSize = 1.mb, flushOnOverflow = false, nullKey = Slice.nulled, nullValue = Segment.nulled)
...
//      import LevelZeroMapEntryWriter._
//
//      val map = Map.persistent[Slice[Byte], Memory](createRandomDir, mmap = false, flushOnOverflow = false, 1.mb, dropCorruptedTailEntries = false, nullKey = Slice.nulled, nullValue = Memory.Null).item
//      map.isEmpty shouldBe true
//      map.close()
//      //recover from an empty map
//      val recovered = Map.persistent[Slice[Byte], Memory](map.path, mmap = true, flushOnOverflow = false, 1.mb, dropCorruptedTailEntries = false, nullKey = Slice.nulled, nullValue = Memory.Null).item
...
//
//      val map = Map.persistent[Slice[Byte], Segment](createRandomDir, mmap = false, flushOnOverflow = false, 1.mb, dropCorruptedTailEntries = false, nullKey = Slice.nulled, nullValue = Segment.nulled).item
//      map.isEmpty shouldBe true
//      map.close()
//      //recover from an empty map
//      val recovered = Map.persistent[Slice[Byte], Segment](map.path, mmap = true, flushOnOverflow = false, 1.mb, dropCorruptedTailEntries = false, nullKey = Slice.nulled, nullValue = Segment.nulled).item
//      recovered.isEmpty shouldBe true
//      recovered.close()
//    }
//
...
//        val recovered = Map.persistent[Slice[Byte], Memory](map.path, mmap = Random.nextBoolean(), flushOnOverflow = false, 1.mb, dropCorruptedTailEntries = false, nullKey = Slice.nulled, nullValue = Memory.Null).item
...
//        val recovered = Map.persistent[Slice[Byte], Segment](map.path, mmap = Random.nextBoolean(), flushOnOverflow = false, 1.mb, dropCorruptedTailEntries = false, nullKey = Slice.nulled, nullValue = Segment.nulled).item
...
//      import LevelZeroMapEntryWriter._
//
//      val map1 = Map.persistent[Slice[Byte], Memory](createRandomDir, mmap = false, flushOnOverflow = false, 1.mb, dropCorruptedTailEntries = false, nullKey = Slice.nulled, nullValue = Memory.Null).item
...
//
//      val map2 = Map.persistent[Slice[Byte], Memory](createRandomDir, mmap = false, flushOnOverflow = false, 1.mb, dropCorruptedTailEntries = false, nullKey = Slice.nulled, nullValue = Memory.Null).item
...
//
//      val map1 = Map.persistent[Slice[Byte], Segment](createRandomDir, mmap = false, flushOnOverflow = false, 1.mb, dropCorruptedTailEntries = false, nullKey = Slice.nulled, nullValue = Segment.nulled).item
...
//
//      val map2 = Map.persistent[Slice[Byte], Segment](createRandomDir, mmap = false, flushOnOverflow = false, 1.mb, dropCorruptedTailEntries = false, nullKey = Slice.nulled, nullValue = Segment.nulled).item
...
//
//      //recover map 1 and it should contain all entries of map1 and map2
//      val map1Recovered = Map.persistent[Slice[Byte], Segment](map1.path, mmap = false, flushOnOverflow = false, 1.mb, dropCorruptedTailEntries = false, nullKey = Slice.nulled, nullValue = Segment.nulled).item
...
//      val skipList2 = SkipList.concurrent[Slice[Byte], Memory](nullKey = Slice.nulled, nullValue = Memory.Null)(keyOrder)
...
//
//      val nextFileSkipList = SkipList.concurrent[Slice[Byte], Memory](nullKey = Slice.nulled, nullValue = Memory.Null)(keyOrder)
