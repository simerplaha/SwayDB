...
//      map.skipList.get(1).value shouldBe Memory.Range(1, 10, Value.FromValue.Null, Value.remove(None))
...
//        recovered.skipList.get(15).value shouldBe Memory.Range(15, 20, Value.FromValue.Null, Value.update(20))
...
//      map1Recovered.skipList.get(10).value shouldBe Memory.Range(10, 15, Value.FromValue.Null, Value.remove(None))
//      map1Recovered.skipList.get(15).value shouldBe Memory.Range(15, 20, Value.FromValue.Null, Value.update(20))
//
...
//      skipList.get(10: Slice[Byte]).value shouldBe Memory.Range(10, 15, Value.FromValue.Null, Value.remove(None))
...
//      skipList2.get(10: Slice[Byte]).value shouldBe Memory.Range(10, 15, Value.FromValue.Null, Value.remove(None))
//      skipList2.get(15: Slice[Byte]).value shouldBe Memory.Range(15, 20, Value.FromValue.Null, Value.update(20))
//
//      map.close()
//      recoveredFile.close()
...
//      nextFileSkipList.get(10: Slice[Byte]).value shouldBe Memory.Range(10, 15, Value.FromValue.Null, Value.remove(None))
