...
//  implicit class ReopenMap(map: PersistentMap[SliceOption[Byte], MemoryOptional, Slice[Byte], Memory]) {
...
//               skipListMerge: SkipListMerger[SliceOption[Byte], MemoryOptional, Slice[Byte], Memory]) = {
