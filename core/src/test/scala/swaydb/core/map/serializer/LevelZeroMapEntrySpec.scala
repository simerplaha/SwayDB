  ...
  "MapEntryWriterLevel0 & MapEntryReaderLevel0" should {
    ...
    "write Put key value" in {
      runThis(100.times) {
        ...
        MapEntryReader.read[MapEntry.Put[Slice[Byte], Memory.Put]](Reader[swaydb.Error.Map](slice.drop(ByteSizeOf.int))).runRandomIO.value.value shouldBe addEntry
    ...
    "write remove key-value" in {
      runThis(100.times) {
        ...
        MapEntryReader.read[MapEntry.Put[Slice[Byte], Memory.Remove]](Reader[swaydb.Error.Map](slice.drop(ByteSizeOf.int))).runRandomIO.value.value shouldBe entry
    ...
    "write Update key value" in {
      runThis(100.times) {
        ...
        MapEntryReader.read[MapEntry.Put[Slice[Byte], Memory.Update]](Reader[swaydb.Error.Map](slice.drop(ByteSizeOf.int))).runRandomIO.value.value shouldBe addEntry
    ...
    "write Function key value" in {
      runThis(100.times) {
        ...
        MapEntryReader.read[MapEntry.Put[Slice[Byte], Memory.Function]](Reader[swaydb.Error.Map](slice.drop(ByteSizeOf.int))).runRandomIO.value.value shouldBe addEntry
    ...
    "write range key-value" in {
      ...
      runThis(100.times) {
        ...
        MapEntryReader.read[MapEntry.Put[Slice[Byte], Memory.Range]](Reader[swaydb.Error.Map](slice.drop(ByteSizeOf.int))).runRandomIO.value.value shouldBe entry
    ...
    "write PendingApply key value" in {
      runThis(100.times) {
        ...
        MapEntryReader.read[MapEntry.Put[Slice[Byte], Memory.PendingApply]](Reader[swaydb.Error.Map](slice.drop(ByteSizeOf.int))).runRandomIO.value.value shouldBe addEntry
