  ...
  "MapEntryWriterLevel0 & MapEntryReaderLevel0" should {
    ...
    "write Put key value" in {
      runThis(100.times) {
        ...
        MapEntryReader.read[MapEntry.Put[Slice[Byte], Memory.Put]](Reader[swaydb.Error.Map](slice.drop(ByteSizeOf.int))).valueIO.value.value shouldBe addEntry

        import LevelZeroMapEntryReader.Level0Reader
        val readEntry = MapEntryReader.read[MapEntry[Slice[Byte], Memory.SegmentResponse]](Reader[swaydb.Error.Map](slice)).valueIO.value.value
    ...
    "write remove key-value" in {
      runThis(100.times) {
        ...
        MapEntryReader.read[MapEntry.Put[Slice[Byte], Memory.Remove]](Reader[swaydb.Error.Map](slice.drop(ByteSizeOf.int))).valueIO.value.value shouldBe entry
    ...
    "write Update key value" in {
      runThis(100.times) {
        ...
        MapEntryReader.read[MapEntry.Put[Slice[Byte], Memory.Update]](Reader[swaydb.Error.Map](slice.drop(ByteSizeOf.int))).valueIO.value.value shouldBe addEntry
    ...
    "write Function key value" in {
      runThis(100.times) {
        ...
        MapEntryReader.read[MapEntry.Put[Slice[Byte], Memory.Function]](Reader[swaydb.Error.Map](slice.drop(ByteSizeOf.int))).valueIO.value.value shouldBe addEntry
    ...
    "write range key-value" in {
      ...
      runThis(100.times) {
        ...
        MapEntryReader.read[MapEntry.Put[Slice[Byte], Memory.Range]](Reader[swaydb.Error.Map](slice.drop(ByteSizeOf.int))).valueIO.value.value shouldBe entry
    ...
    "write PendingApply key value" in {
      runThis(100.times) {
        ...
        MapEntryReader.read[MapEntry.Put[Slice[Byte], Memory.PendingApply]](Reader[swaydb.Error.Map](slice.drop(ByteSizeOf.int))).valueIO.value.value shouldBe addEntry
    ...
    "write, remove & update key-value" in {
      runThis(100.times) {
        ...
        val recoveryResult = MapCodec.read[Slice[Byte], Memory.SegmentResponse](bytes, false).valueIO.value
