...
//      val map = SkipList.concurrent[SliceOption[Byte], MemoryOptional, Slice[Byte], Memory](Slice.Null, Memory.Null)(keyOrder)
...
//      import LevelZeroMapEntryReader.Level0Reader
//      val readMap = SkipList.concurrent[SliceOption[Byte], MemoryOptional, Slice[Byte], Memory](Slice.Null, Memory.Null)(keyOrder)
