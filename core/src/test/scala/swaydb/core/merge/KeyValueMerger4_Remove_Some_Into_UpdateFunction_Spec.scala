...
class KeyValueMerger4_Remove_Some_Into_UpdateFunction_Spec extends WordSpec with Matchers with CommonAssertions {
  ...
  "Remove(Some) -> Put(None, None)" when {
    "Put(None, None)" in {
      ...
      (Memory.Remove(1, deadline), Memory.UpdateFunction(1, incrementBy1FunctionId, None)).merge shouldBe Memory.UpdateFunction(1, incrementBy1FunctionId, deadline)
    }
  }
  ...
  "Remove(Some) -> Put(None, Some)" when {
    "Put(None, HasTimeLeft-Greater)" in {
      ...
      (Memory.Remove(1, deadline), Memory.UpdateFunction(1, incrementBy1FunctionId, deadline2)).merge shouldBe Memory.UpdateFunction(1, incrementBy1FunctionId, deadline)
    }
    ...
    "Put(None, HasNoTimeLeft-Greater)" in {
      ...
      (Memory.Remove(1, deadline), Memory.UpdateFunction(1, incrementBy1FunctionId, deadline2)).merge shouldBe Memory.UpdateFunction(1, incrementBy1FunctionId, deadline2)
    }
