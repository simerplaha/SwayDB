...
//import swaydb.core.level.PathsIterator
...
//
//      val paths = (1 to 6) map (_ => createRandomIntDirectory)
//
//      val pathsWrapper = PathsIterator(paths)
//      val segments =
//        if (persistent)
//          segment.put(keyValues2, 33.bytes, 0.1, pathsWrapper).assertGet
//        else
//          segment.put(keyValues2, 16.bytes, 0.1, pathsWrapper).assertGet
//
...
//      segments(0).path.getParent shouldBe paths(0)
//      segments(1).path.getParent shouldBe paths(1)
//      segments(2).path.getParent shouldBe paths(2)
//      segments(3).path.getParent shouldBe paths(3)
//      segments(4).path.getParent shouldBe paths(4)
//
//      //resets the next path to be used to head.
////      pathsWrapper.currentIndex shouldBe 0
//      ???
//    }
//  }
//}