  ...
  "Segment.keyValueCount" should {
        ...
        assertSegment(
          ...
          assert =
            (keyValues, segment) => {
              ...
              segment.getBloomFilterKeyValueCount().assertGet shouldBe 1
            }
        )
      }
    }
        ...
        assertSegment(
          ...
          assert =
            (keyValues, segment) => {
              ...
              segment.getBloomFilterKeyValueCount().assertGet shouldBe keyValues.size
            }
        )
      }
    }
    ...
    "return the number key-values in nested Groups" in {
      runThis(10.times) {
        ...
        group2.stats.bloomFilterKeysCount shouldBe (group1KeyValues.size + group2KeyValues.size)
        ...
        group3.stats.bloomFilterKeysCount shouldBe (group1KeyValues.size + group2KeyValues.size + group3KeyValues.size)
        ...
        group4.stats.bloomFilterKeysCount shouldBe group4KeyValues.size
