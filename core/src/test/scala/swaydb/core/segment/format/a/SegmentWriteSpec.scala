...
import swaydb.core.segment.{MemorySegment, PersistentSegment, PersistentSegmentOne, Segment, SegmentIO, ThreadReadState}
...
sealed trait SegmentWriteSpec extends TestBase {
    ...
    "create a Segment" in {
      runThis(100.times, log = true) {
        assertSegment(
          ...
          segmentConfig =
            SegmentBlock.Config.default.copy(Int.MaxValue, randomIntMax(keyValuesCount)),
  ...
  //          mmapSegmentsOnRead = levelStorage.mmapSegmentsOnRead,
  //          mmapSegmentsOnWrite = levelStorage.mmapSegmentsOnWrite,
  //          minSegmentSize = Segment.segmentSizeForMerge(temporarySegment) / 20,
  //          valuesConfig = valuesConfig,
  //          sortedIndexConfig = sortedIndexConfig,
  //          binarySearchIndexConfig = binarySearchIndexConfig,
  //          hashIndexConfig = hashIndexConfig,
  ...
  //        }
  //
  //        val segment = TestSegment(keyValuesWithEmptyValues.toSlice)
  //
