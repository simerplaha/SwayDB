...
//
//          val compressedBytes = Block.compress(headerSize, uncompressedBytes, Seq.empty, "test-block")
//
...
//          val compressedBytes = Block.compress(headerSize, uncompressedBytes, Seq(compression), "test-block")
...
//    val compressedBytes = Block.compress(headerSize, bytes, Seq(compression), "testBlock")
//
//    val ref = BlockRefReader[SegmentBlock.Offset](compressedBytes)
//
...
//    val compressedChildBytes1 = Block.compress(headerSize, child1Bytes, Seq(compression), "testBlock1")
//    val compressedChildBytes2 = Block.compress(headerSize, child2Bytes, Seq(compression), "testBlock2")
//
...
//    val compressedRootBytes = Block.compress(headerSize, rootUncompressedBytes, Seq(compression), "compressedRootBlocks")
//
