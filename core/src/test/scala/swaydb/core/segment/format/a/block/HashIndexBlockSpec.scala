...
//            ).createBlockDataReader(SegmentBlock.createUnblockedReader(uncompressedState.bytes).get)
//          ).get
...
//              headerSize = 0,
//              compressionInfo = None
//            ).createBlockDataReader(SegmentBlock.createUnblockedReader(compressedState.bytes).get)
//          ).get
//
...
//                key = keyValue.key,
//                blockReader = hashIndex.createBlockDataReader(SegmentBlock.createUnblockedReader(alteredBytes).get),
