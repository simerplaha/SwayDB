...
//            if (valueBytes.isNone) {
//              offset
//            } else {
//              keyValuesOffset += ((offset, valueBytes.get))
//              ValuesBlock.read(offset, valueBytes.get.size, unblocked).value shouldBe valueBytes.get.value
//              offset + valueBytes.get.size
//            }
//        }
//
