...
//        initialSegment add Memory.put(key = 1, value = Some(1), previous = None)
//        initialSegment add Memory.put(key = 2, value = Some(2), previous = initialSegment.lastOption) //total segmentSize is 133.bytes
//
