...
//import swaydb.core.segment.format.a.{SegmentFooter, SegmentReader, SegmentWriter}
...
//      initialSegment += Transient.put(key = 2, value = Some(2), previous = initialSegment.lastOption) //total segmentSize is 60 bytes
//
