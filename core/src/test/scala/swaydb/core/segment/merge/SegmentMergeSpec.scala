...
//        segment1 add Memory.put(key = 1, value = Some(1), previous = segment1.lastOption)
//        segment1 add Memory.put(key = 2, value = Some(2), previous = segment1.lastOption) //total segmentSize is 144.bytes
//
//        val smallerLastSegment = SegmentBuffer()
//        smallerLastSegment add Memory.put(key = 3, value = Some(3), previous = None) //total segmentSize is 105.bytes
//
...
//
//      def assert(segments: Array[Iterable[Memory]]) = {
...
//            Memory.remove(2),
//            Memory.put(3, 3),
//            Memory.put(4, 4), //51.byte Segment size
//            Memory.Range(5, 10, Some(Value.remove(None)), Value.update(5)) //56.bytes (segment size)
//          )
//
