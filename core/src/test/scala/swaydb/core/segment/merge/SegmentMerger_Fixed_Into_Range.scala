  ...
  "Single into Range" when {
    ...
    "left" in {
      ...
      runThis(10000.times) {
        ...
        val expectedKeyValue = Memory.Range(1, 10, expectedFromValue.toFromValue().valueIO.value, oldKeyValue.rangeValue)
      ...
      runThis(10000.times) {
        ...
        val expectedKeyValue =
          Slice(
            ...
            Memory.Range(midKey, 10, expectedFromValue.toFromValue().valueIO.value, oldKeyValue.rangeValue)
          )
