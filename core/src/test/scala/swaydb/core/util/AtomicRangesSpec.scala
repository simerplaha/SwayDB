...
//
//      atomic
//        .writeTransaction(fromKey = 1, toKey = 10, toKeyInclusive = randomBoolean()) {
//          executed = true
//        }
//        .await
//
...
//            Future {
//              ranges
//                .writeTransaction(fromKey = 10, toKey = 20, toKeyInclusive = true) {
//                  sleep(1.second)
...
//
//          Future {
//            ranges.writeTransaction(fromKey = 20, toKey = 30, toKeyInclusive = false, readOrWriteAction()) {
...
//                Future {
//                  ranges
//                    .writeTransaction(fromKey = 10, toKey = 20, toKeyInclusive = false, AtomicRanges.Action.Write) {
//                      sleep(3.second)
//                      firstExecuted = System.nanoTime()
//                      println("First executed")
//                    }
...
//              Future {
//                ranges.writeTransaction(fromKey = 20, toKey = 30, toKeyInclusive = secondToInclusive, readOrWriteAction()) {
//                  secondExecuted = System.nanoTime()
//                  println("Second executed")
//                }.await
...
//          Future {
//            ranges
//              .writeTransaction(fromKey = rangeToReserve._1, toKey = rangeToReserve._2, toKeyInclusive = true, readOrWriteAction()) {
...
//          val future2 =
//            Future {
//              ranges.writeTransaction(fromKey = from, toKey = to, toKeyInclusive = true, AtomicRanges.Action.Write) {
//                secondExecuted = System.nanoTime()
//                println("Second executed")
//              }.await
//            }
...
//        Future {
//          ranges
//            .writeTransaction(fromKey = from, toKey = to, toKeyInclusive = true, readOrWriteAction()) {
...
//
//        Future {
//          ranges.writeTransaction(fromKey = from2, toKey = to2, toKeyInclusive = true, readOrWriteAction()) {
//            eitherOne(sleep(randomIntMax(20).milliseconds), ()) //sleep optionally
