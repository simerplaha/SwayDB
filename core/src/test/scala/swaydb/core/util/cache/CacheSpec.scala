...
//        val cache =
//          if (delayedIO)
//            Cache.blockIO[Unit, Int](blockIO = (_: Unit) => isSynchronised, reserved = (_: Unit) => isReserved, stored = (_: Unit) => true)(_ => mock.apply())
//          else
...
//          val cache =
//            if (delayedIO)
//              Cache.blockIO[Unit, Int](blockIO = _ => false, reserved = _ => true, stored = _ => true) {
//                _ =>
//                  invokeCount += 1
