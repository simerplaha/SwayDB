...
object Cache {
  ...
  case class EnableBlockCache(blockSize: Int, capacity: Int) extends Enabled

  case class EnableKeyValueCache(capacity: Int) extends Enabled

  case class EnableBoth(blockSize: Int,
                        capacity: Int) extends Enabled
}
