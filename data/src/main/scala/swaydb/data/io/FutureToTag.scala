...
/**
  ...
  * following implementation for non-blocking api or use [[IOToTag]] for blocking APIs.
  */
trait FutureToTag[O[_]] {
  /**
...
object FutureToTag {
  ...
  implicit object FutureToFuture extends FutureToTag[Future] {
