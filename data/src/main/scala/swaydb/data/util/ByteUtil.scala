...
object ByteUtil {
  ...
  def readInt[E >: swaydb.Error.IO : ErrorHandler](reader: Reader[E]): IO[E, Int] = {
  ...
  def readLong[E >: swaydb.Error.IO : ErrorHandler](reader: Reader[E]): IO[E, Long] =
    reader.read(ByteSizeOf.long) map readLong

  def readBoolean[E >: swaydb.Error.IO : ErrorHandler](reader: Reader[E]): IO[E, Boolean] =
    reader.get() map (_ == 1)

  def readString[E >: swaydb.Error.IO : ErrorHandler](reader: Reader[E], charset: Charset): IO[E, String] =
    reader.size flatMap {
      size =>
  ...
  def readSignedInt[E >: swaydb.Error.IO : ErrorHandler](reader: Reader[E]): IO[E, Int] = {
  ...
  def readUnsignedInt[E >: swaydb.Error.IO : ErrorHandler](reader: Reader[E]): IO[E, Int] =
    IO {
      var i = 0
      var int = 0
      var read = 0
  ...
  def readSignedLong[E >: swaydb.Error.IO : ErrorHandler](reader: Reader[E]): IO[E, Long] =
  ...
  def readUnsignedLong[E >: swaydb.Error.IO : ErrorHandler](reader: Reader[E]): IO[E, Long] =
    IO {
      var i = 0
      var long = 0L
      var read = 0L
