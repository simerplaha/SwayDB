...
//        val dataTypeLeft = readerLeft.unsafeGet()
//
...
//        val dataTypeRight = readerRight.unsafeGet() //read the data type to apply ordering (default or custom)
//
