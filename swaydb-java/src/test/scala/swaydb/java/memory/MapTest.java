...
class MemoryMapFunctionsDisabledTest extends MapTest {
  ...
  public <K, V> MapIO<K, V, PureFunction.Disabled<K, V>> createMap(Serializer<K> keySerializer,
                                                                   Serializer<V> valueSerializer) {
    MapIO<K, V, PureFunction.Disabled<K, V>> map =
...
abstract class MapTest extends TestBase implements JavaEventually {
  ...
  public abstract <K, V> MapIO<K, V, PureFunction.Disabled<K, V>> createMap(Serializer<K> keySerializer,
                                                                            Serializer<V> valueSerializer) throws IOException;
  ...
  void removeTest() throws IOException {
    MapIO<Integer, Integer, PureFunction.Disabled<Integer, Integer>> map = createMap(intSerializer(), intSerializer());
...
//    assertEquals(10, map.get(2).get().get());
  ...
  void comparatorTest() {
    ...
    Map.Config<Integer, Integer, PureFunction.Disabled<Integer, Integer>, Void> config =
    ...
    MapIO<Integer, Integer, PureFunction.Disabled<Integer, Integer>> map =
      config
        .init()
        .get();
  ...
  void createMapWithCustomSerializer() throws IOException {
    ...
    MapIO<Key, Value, PureFunction.Disabled<Key, Value>> map =
