 ...
 *
 * This instance stores the result of the recovery of the target [[swaydb.core.file.CoreFile]]
 ...
 */
final case class LogRecoveryResult[+T](item: T, result: IO[swaydb.Error.Log, Unit])
