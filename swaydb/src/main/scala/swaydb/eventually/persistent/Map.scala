...
object Map extends LazyLogging {
  ...
  def apply[K, V, F, T[_]](dir: Path,
                           ...
                           acceleration: LevelZeroMeter => Accelerator = Accelerator.noBrakes())(implicit keySerializer: Serializer[K],
                                                                                                 ...
                                                                                                 memorySweeperEC: ExecutionContext = SwayDB.sweeperExecutionContext): IO[swaydb.Error.Boot, swaydb.Map[K, V, F, T]] = {
    ...
    Core(
      ...
      config =
        DefaultEventuallyPersistentConfig(
          ...
          memoryLevelMinUncompressedSegmentSize = memoryLevelSegmentSize,
          persistentLevelMinUncompressedSegmentSize = persistentLevelSegmentSize,
