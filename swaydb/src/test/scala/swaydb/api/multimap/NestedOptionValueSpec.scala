  ...
  "Option[Option[V]]" in {
    TestCaseSweeper {
      implicit sweeper =>
        ...
        val root = swaydb.memory.MultiMap_Experimental[Int, Int, Option[String], Nothing, Bag.Less]().sweep(_.delete())
  ...
  "Option[Empty[V]]" in {
    TestCaseSweeper {
      implicit sweeper =>
        ...
        val root = swaydb.memory.MultiMap_Experimental[Int, Int, Option[Value], Nothing, Bag.Less]().sweep(_.delete())
