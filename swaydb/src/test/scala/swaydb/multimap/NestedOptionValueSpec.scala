  ...
  "Option[Option[V]]" in {
    TestCaseSweeper {
      implicit sweeper =>
        ...
        val root = swaydb.memory.MultiMap[Int, Int, Option[String], Nothing, Bag.Less]().sweep()
  ...
  "Option[Empty[V]]" in {
    TestCaseSweeper {
      implicit sweeper =>
        ...
        val root = swaydb.memory.MultiMap[Int, Int, Option[Value], Nothing, Bag.Less]().sweep()
